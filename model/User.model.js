...
//Get fullname
userSchema.virtual("User Fullname").get(function () {
  return `${this.firstname} ${this.lastname}`;
});

//get user initials
userSchema.virtual("User Initials").get(function () {
  return `${this.firstname[0]}${this.lastname[0]}`;
});

//get posts count
userSchema.virtual("User Post Counts").get(function () {
  return this.posts.length;
});

//get followers count
userSchema.virtual("User Followers Count").get(function () {
  return this.followers.length;
});

//get followers count
userSchema.virtual("User Following Count").get(function () {
  return this.following.length;
});

//get viewers count
userSchema.virtual("User Viewers Count").get(function () {

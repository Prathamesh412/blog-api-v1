...
const postSubmitCtr = async(req,res,next)=>{
...
const singlePostCtr = async(req,res,next)=>{
    try {
        //find the post
...
const allPostsCtr = async(req,res,next)=>{
    try{
        //Find all posts
...
const postDeleteCtr = async(req,res,next)=>{
    try{
        //find the post
    const post = await Post.findById(req.params.id);
...
const postUpdateCtr = async(req,res,next)=>{
    const { title, description, category } = req.body;
    try {
      //find the post
      const post = await Post.findById(req.params.id);
